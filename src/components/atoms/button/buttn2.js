 ...
 * })
 * // Returns: '<button type="button" class="btn danger" data-confirm="true" disabled aria-label="Delete item">Delete</button>'
 * 
 * @example
...
export const button = ({
    ...
    const ariaLabelAttr = ariaLabel ? ` aria-label="${escapeAttr(ariaLabel)}"` : '';
